...
\uses{lem:charpoly_monic_degree, lem:exists_large_eval_nonzero}
...
\uses{thm:main_technical_theorem, lem:charpoly_eval_nonzero_large, lem:linear_relation_from_adjugate}
